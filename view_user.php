...
<div class="container-fluid">
	<div class="card card-widget widget-user shadow">
      ...
      <div class="widget-user-image">
      	...
      	<span class="brand-image img-circle elevation-2 d-flex justify-content-center align-items-center bg-dark text-white font-weight-500" style="width: 90px;height:90px"><h4><?php echo strtoupper(substr($firstname, 0,1).substr($lastname, 0,1)) ?></h4></span>
      	<?php else: ?>
